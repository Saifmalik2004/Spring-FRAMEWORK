...
# 📌 Adding a Home Page to Education Hub  

In this section, we are accelerating our development by adding a **Home Page** to our website, "Education Hub."  



## 🏠 Home Page Structure  

The **Home Page (`home.html`)** includes:  
...
## 🎯 **Home Page - Banner & Features Section**  
            ...
            <div class="row align-items-center pt-sm-5 pt-4">
                ...
                <div class="col-md-6 right-banner-2 text-end position-relative mt-md-0 mt-5">
                    <div class="sub-banner-image mx-auto">
                        <img src="assets/images/banner.png" class="img-fluid position-relative" alt="Education Hub Banner">
                    </div>
...
<section class="services-w3l-block py-5" id="features">
    <div class="container py-md-5 py-4">
        <div class="title-main text-center mx-auto mb-md-5 mb-4" style="max-width:500px;">
            ...
            <h3 class="title-style">Achieve Your Goals With Education Hub</h3>
        </div>
        <div class="row">
...
```
# 🎯 **Home Page - home image with content & why choose us section**  

After the **feature**, our home page includes:  
✅ A **home image with content Section**  
            ...
            <div class="row content23-col-2 text-center">
                <div class="col-md-6">
                    <div class="content23-grid content23-grid1">
                        <h4><a>Expert Teachers</a></h4>
                    </div>
                </div>
                <div class="col-md-6 mt-md-0 mt-4">
                    <div class="content23-grid content23-grid2">
                        <h4><a>Safe Environment</a></h4>
                    </div>
                </div>
            </div>
        </div>
...
# 🎯 **Home Page - stats blocks  & Testimonial section**  
                        ...
                        <ul>
                            <li class="anim1">
                                ...
                                <blockquote class="quote"><q>I am very happy that my son is studying in the
                                    Education Hub. The support provided by the teachers is great and the curriculum
                            ...
                            <li class="anim2">
                                ...
                                <blockquote class="quote"><q>My child never felt pressure of studies in
                                    the Education Hub. He is always encouraged to follow his own interest
                            ...
                            <li class="anim5">
                                <img src="assets/images/testi2.jpg" class="img-fluid rounded-circle"
                                    alt="client image" />
                                <blockquote class="quote"><q>Education Hub supports both online and offline
...
# 🎯 **Home Page - Course section  & Call block**  

After the **Testimonial**, our home page includes:  
✅ A **Course section**  
✅ A **Call block section** 
...
# 🎯 **Home Page - Footer  & Some java script**  
            ...
            <div class="container pt-md-4">
                <div class="row footer-top-29">
                    <div class="col-lg-4 col-md-6 footer-list-29">
                        ...
                        <p class="mb-2 pe-xl-5">Address : Education Hub, 10001, 5th Avenue, #06 lane street, NY - 62617.
                        </p>
                        <p class="mb-2">Phone Number : <a href="tel:+1(21) 234 4567">+1(21) 673 4587</a></p>
                        <p class="mb-2">Email : <a href="mailto:info@eazyschool.com">info@educationhub.com</a></p>
                    </div>
                ...
                <!-- copyright -->
                <p class="copy-footer-29 text-center pt-lg-2 mt-5 pb-2">© 2023 Education Hub. All rights reserved. Design
